...
from lipnet.gpt2_dataset import GridDataset
...
def train(model: LipNet, train_dataset: GridDataset, val_dataset: GridDataset, optimizer: Optimizer,
          ...
          val_cers: List[float]):
    loader = train_dataset.get_data_loader(batch_size, num_workers, shuffle=False)
    ...
    for epoch in range(start_epoch, start_epoch + 10):
        ...
        for (i, record) in enumerate(loader):
            ...
            logits = model(images_tensor, record['prev_words'])
